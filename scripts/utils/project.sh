...
create_project() {
    ...
    # 匯出常用變數
    echo 'NPM_CONFIG_USERCONFIG=${PROJECT_PATH}/.npmrc' >> ${ENVIROMENTS_PATH}/${CUR_ENV}/${VOLUMES_DIR}/${PROJECT_NAME}/project.env
    echo 'NPM_CONFIG_CACHE=${PROJECT_PATH}/.npm' >> ${ENVIROMENTS_PATH}/${CUR_ENV}/${VOLUMES_DIR}/${PROJECT_NAME}/project.env
    echo 'CYPRESS_CACHE_FOLDER=${PROJECT_PATH}/.npm/.cache/Cypress' >> ${ENVIROMENTS_PATH}/${CUR_ENV}/${VOLUMES_DIR}/${PROJECT_NAME}/project.env
