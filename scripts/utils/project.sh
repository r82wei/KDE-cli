...
create_project() {
    ...
    # 匯出常用變數
    echo 'NPM_CONFIG_USERCONFIG=${PROJECT_PATH}/.npmrc' >> ${PROJECT_PATH}/project.env
    echo 'NPM_CONFIG_CACHE=${PROJECT_PATH}/.npm' >> ${PROJECT_PATH}/project.env
    echo 'CYPRESS_CACHE_FOLDER=${PROJECT_PATH}/.npm/.cache/Cypress' >> ${PROJECT_PATH}/project.env
