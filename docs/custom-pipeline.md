...
KDE_STAGE_deploy_canary_SCRIPT=deploy-canary.sh
KDE_STAGE_deploy_canary_IMAGE=r82wei/deploy-env:1.0.0

KDE_STAGE_verify_canary_SCRIPT=verify-canary.sh
KDE_STAGE_verify_canary_IMAGE=r82wei/deploy-env:1.0.0

KDE_STAGE_deploy_full_SCRIPT=deploy-full.sh
KDE_STAGE_deploy_full_IMAGE=r82wei/deploy-env:1.0.0
...
# Validate 階段
KDE_STAGE_validate_SCRIPT=validate-config.sh
KDE_STAGE_validate_IMAGE=r82wei/deploy-env:1.0.0
...
# Security 階段
KDE_STAGE_security_SCRIPT=security-scan.sh
KDE_STAGE_security_IMAGE=aquasec/trivy:latest
...
# Unit Test 階段
KDE_STAGE_unit_test_SCRIPT=unit-test.sh
KDE_STAGE_unit_test_IMAGE=node:20

# Integration Test 階段
KDE_STAGE_integration_test_SCRIPT=integration-test.sh
KDE_STAGE_integration_test_IMAGE=node:20

# Package 階段
KDE_STAGE_package_SCRIPT=package.sh
KDE_STAGE_package_IMAGE=node:20

# Deploy Staging 階段
KDE_STAGE_deploy_staging_SCRIPT=deploy-staging.sh
KDE_STAGE_deploy_staging_IMAGE=r82wei/deploy-env:1.0.0

# Smoke Test 階段
KDE_STAGE_smoke_test_SCRIPT=smoke-test.sh
KDE_STAGE_smoke_test_IMAGE=node:20

# Deploy Production 階段
KDE_STAGE_deploy_production_SCRIPT=deploy-production.sh
KDE_STAGE_deploy_production_IMAGE=r82wei/deploy-env:1.0.0

# Monitor 階段
KDE_STAGE_monitor_SCRIPT=monitor.sh
KDE_STAGE_monitor_IMAGE=grafana/grafana:latest
